document.addEventListener("DOMContentLoaded", () => {
	const journeyBoardHead = document.querySelector("#journey-board-head");
	const journeyBoardBody = document.querySelector("#journey-board-body");
	const journeyBoardButton = document.querySelector("#journey-board-button");
	const journeyBoardTaskNumber = document.querySelector("#journey-board-task-number");
	const journeyBoardTask = document.querySelector("#journey-board-task");
	const journeyBoardList = document.querySelector("#journey-board-list");
	const journeyBoardActive = document.querySelectorAll(".journey-board-active");
	const projectLoader = document.querySelector("#loader");
	const projectTask = document.querySelector("#task");
	...
	journeyBoardButton.addEventListener("click", () => {
		if (journeyBoardButton.getAttribute("data-active") === "0") {
			...
			if (window.innerWidth > 1200) {
				journeyBoardHead.style.width = "20vw";
				journeyBoardBody.style.width = "20vw";
			}
			else if ((window.innerWidth > 600) && (window.innerWidth < 1200)) {
				journeyBoardHead.style.width = "25vw";
				journeyBoardBody.style.width = "25vw";
			}
			else {
				journeyBoardHead.style.width = "40vw";
				journeyBoardBody.style.width = "40vw";
			}
	...
	fixJourneyBoardHeight(journeyBoardButton, journeyBoardBody);
	...
	fetch("project.json").then((response) => {
		response.json().then((data) => {
			...
			task.assets.forEach((asset) => {
				...
				span.setAttribute("class", "journey-board-item");
				...
				if (asset.asset_type === "display_asset") {
					if (asset.asset_content === "reflection") {
						...
						assetHead.setAttribute("class", "asset-head");
						assetHeading.setAttribute("class", "asset-heading");
						assetBody.setAttribute("class", "asset-body");
					...
					if (asset.asset_content === "reflection") {
						...
						assetInput.setAttribute("placeholder", "Reflect as per given guidelines");
						assetButton.setAttribute("class", "asset-icon");
						assetButton.setAttribute("data-active", "0");
						assetButtonIcon.setAttribute("class", "material-symbols-rounded");
						...
						assetInput.setAttribute("placeholder", "Write an article as per given guidelines");
						assetButton.setAttribute("class", "asset-icon");
						assetButton.setAttribute("data-active", "0");
						assetButtonIcon.setAttribute("class", "material-symbols-rounded");
						...
						assetSubThreadContainer.setAttribute("id", "asset-sub-thread-container");
						...
						assetThreadButton.addEventListener("click", () => {
							...
							const assetSubThreadContainerNew = assetSubThreadContainer.cloneNode();
							...
							const assetSubThreadButtonTextNew = assetSubThreadButtonText.cloneNode();
							const assetThreadSummaryHeadingNew = assetThreadSummaryHeading.cloneNode();
							...
							assetBody.insertBefore(assetSubThreadContainerNew, assetThreadButton);
							assetBody.insertBefore(assetSubThreadButtonNew, assetThreadButton);
							assetBody.insertBefore(assetThreadSummaryHeadingNew, assetThreadButton);
						...
						const assetThreadIntroductionText = document.createElement("textarea");
						const assetThreadHeading = document.createElement("h4");
						const assetSubThreadContainer = document.createElement("div");
						const assetSubThread = document.createElement("textarea");
						const assetSubThreadNew = assetSubThread.cloneNode();
						...
						assetThreadIntroduction.setAttribute("id", "asset-thread-introduction");
						assetThreadIntroductionText.setAttribute("class", "asset-active");
						assetThreadIntroductionText.setAttribute("id", "asset-thread-introduction-text");
						assetThreadIntroductionText.setAttribute("placeholder", "Enter text here");
						assetThreadHeading.setAttribute("class", "asset-active");
						assetThreadHeading.setAttribute("id", "asset-thread-heading");
						assetSubThreadContainer.setAttribute("class", "asset-active");
						assetSubThreadContainer.setAttribute("id", "asset-sub-thread-container");
						...
						assetThreadConclusion.setAttribute("placeholder", "Enter text here");
						assetButton.setAttribute("class", "asset-icon");
						assetButton.setAttribute("data-active", "0");
						assetButtonIcon.setAttribute("class", "material-symbols-rounded");
						...
						assetThreadButton.addEventListener("click", () => {
							...
							const assetSubThreadButtonNew = assetSubThreadButton.cloneNode();
							const assetSubThreadButtonTextNew = assetSubThreadButtonText.cloneNode();
							const assetThreadArgumentHeadingNew = assetThreadArgumentHeading.cloneNode();
							...
							assetBody.insertBefore(assetSubThreadContainerNew, assetThreadButton);
							assetBody.insertBefore(assetSubThreadButtonNew, assetThreadButton);
							assetBody.insertBefore(assetThreadArgumentHeadingNew, assetThreadButton);
...
function fixJourneyBoardHeight(button, body) {
